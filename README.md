...
<div>
  ...
  <br><br>
  <p> Objetivo: Criar uma calculadora em que o usuário pode realizar as operações de soma, subtração, multiplicação e divisão. </p>
<h3>▶ Como rodar:</h3>
<div>
    <p>Você pode acessar <a href="https://calculadora-two-omega.vercel.app/">clicando aqui</a>.</p>
</div>
  <h3>💻 TECNOLOGIA:</h3>
